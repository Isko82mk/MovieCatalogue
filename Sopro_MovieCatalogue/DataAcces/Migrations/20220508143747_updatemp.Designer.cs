...
namespace DataAcces.Migrations
{
    ...
    [Migration("20220508143747_updatemp")]
    partial class updatemp
    {
            ...
            modelBuilder.Entity("Model.Genre", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, GenreMovie = 0, MovieId = 2 },
                        new { Id = 3, GenreMovie = 0, MovieId = 3 }
                    );
                });
            ...
            modelBuilder.Entity("Model.MoviePerson", b =>
                {
                    ...
                    b.HasData(
                        new { MovieId = 1, PersonId = 1, Id = 1 },
                        new { MovieId = 2, PersonId = 4, Id = 2 },
                        new { MovieId = 3, PersonId = 5, Id = 3 }
                    );
                });
            ...
            modelBuilder.Entity("Model.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 4, FirstName = "Arnold", LastName = "Schwarzenegger", Role = 0 },
                        new { Id = 5, FirstName = "Michael ", LastName = "Keaton", Role = 0 }
                    );
                });
